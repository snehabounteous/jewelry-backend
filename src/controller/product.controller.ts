...
export class ProductController {
  ...
  static async getProductByCategoryWithImagesAndReviews(req: Request, res: Response) {
    try {
      const { categoryId } = req.params;
      const products = await ProductService.getProductByCategoryWithImagesAndReviews(categoryId);
      res.json(products);
    } catch (err) {
